package com.smartfoxserver.v2
{
   ...
   [Event(name="cryptoInit",type="com.smartfoxserver.v2.core.SFSEvent")]
   ...
   public class SmartFox extends EventDispatcher
   {
      ...
      private var _subVersion:int = 10;
      ...
      public function setClientDetails(platformId:String, version:String) : void
      {
         ...
         this._clientDetails = platformId != null ? platformId.replace(this.CLIENT_TYPE_SEPARATOR," ") : "";
         this._clientDetails += this.CLIENT_TYPE_SEPARATOR;
         this._clientDetails += version != null ? version.replace(this.CLIENT_TYPE_SEPARATOR," ") : "";
      }
      ...
      {
         this.validateAndStoreConfig(cfg);
         this.connect();
      }
      ...
      private function onConfigLoadSuccess(evt:SFSEvent) : void
      {
         ...
         this.validateAndStoreConfig(cfgData);
      ...
      private function handleConnectionProblem(evt:BitSwarmEvent) : void
      {
         ...
         if(this._bitSwarm.connectionMode == ConnectionMode.SOCKET && this._useBlueBox)
         {
            ...
            bbPort = this.DEFAULT_HTTP_PORT;
            if(this.config != null)
            {
               bbPort = this.config.forceBlueBoxOverHttps ? this.config.httpsPort : this.config.httpPort;
            }
      ...
      {
         var req:IRequest = new HandshakeRequest(this.version,this._clientDetails,isReconnection ? this._sessionToken : null);
         this.send(req);
      }
