package com.smartfoxserver.v2.bitswarm.bbox
{
   ...
   public class BBClient extends EventDispatcher
   {
      ...
      {
         this._pollSpeed = value >= this.MIN_POLL_SPEED && value <= this.MAX_POLL_SPEED ? value : this.DEFAULT_POLL_SPEED;
      }
      ...
      public function set useHttps(value:Boolean) : void
      {
      ...
      public function connect(host:String = "127.0.0.1", port:int = 8080) : void
      {
         ...
         this._host = host;
         this._port = port;
         var proto:String = this._useHttps ? "https://" : "http://";
         this._bbUrl = proto + this._host + ":" + port + "/" + this.BB_SERVLET;
